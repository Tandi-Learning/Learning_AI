...
namespace WiredBrain_WebApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Source Codes\Learning_AI\ML.NET Intro\WiredBrain.WebApp\languageDetection_vNext.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Message",outputColumnName:@"Message")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03328492F,L2Regularization=0.03125F,LabelColumnName=@"Language",FeatureColumnName=@"Features"}))      
